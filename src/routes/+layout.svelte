	...
	<div class="min-h-screen flex flex-col">
		<header class="border-b" style="background: #1a2f2f; border-color: #3d5f5f;">
			<nav class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
				<a href={`${base}/`} class="text-2xl font-semibold" style="font-family: 'Cinzel', serif; color: #b5c4c4;">
					L<span style="font-size: 0.65em; vertical-align: baseline; position: relative; top: 0.15em;">x</span>Merit
				</a>
				<div class="flex items-center gap-6">
					<a href={`${base}/features`} class="transition-colors" style="color: #8fa8a8;" onmouseenter={(e) => e.currentTarget.style.color = '#d4dada'} onmouseleave={(e) => e.currentTarget.style.color = '#8fa8a8'}>Features</a>
