		...
		<header class="border-b" style="background: #1a2f2f; border-color: #3d5f5f;">
			<nav class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
				...
				<div class="flex items-center gap-6">
					<a href={`${base}/blog`} class="transition-colors" style="color: #8fa8a8;" onmouseenter={(e) => e.currentTarget.style.color = '#d4dada'} onmouseleave={(e) => e.currentTarget.style.color = '#8fa8a8'}>Dev Diary</a>
